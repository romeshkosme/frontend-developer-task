    ...
    <>
      ...
      <div className="bg-gradient-to-r p-[2px] w-[90%] max-w-[463px] from-[#969696] to-[#343434] rounded-[8px]">
        <div className="rounded-[8px] bg-[#27292D] max-w-[463px]  py-[40px] px-[24px] cursor-default">
          ...
          <div className="flex flex-col mt-[20px]">
            ...
            <div className="relative">
              <input
                ...
                className="border-[1.5px] border-[#35373B] rounded-[4px] bg-transparent w-full max-w-[415px] h-[43px] mt-[8px] px-2 text-white focus:outline-none"
              />
              <img
          ...
          {!isModal ? (
            <Link to={"/feed"}>
              <button className="bg-[#4A96FF] rounded-[4px] text-white text-[16px] font-[500] w-full h-[43px] mt-[20px]">
                Login now
              </button>
            </Link>
          ) : (
